...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    _navigationItems = [
      ...
      {'icon': Icons.receipt_rounded, 'label': 'Transactions', 'page': TransactionsPage()},
  ...
  void _toggleDarkMode() {
    setState(() {
      ...
      _navigationItems = _navigationItems.map((item) {
        ...
        } else if (item['label'] == 'Ledgers' && item['isDropdown'] == true) {
          return {
            'icon': item['icon'],
            'label': item['label'],
            'isDropdown': true,
        ...
        } else if (item['label'] == 'Reports' && item['isDropdown'] == true) {
          return {
            'icon': item['icon'],
            'label': item['label'],
            'isDropdown': true,
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (item['isDropdown'] == true) {
                        return ExpansionTile(
                          leading: Icon(
                            ...
                            color: _darkModeState >= 1 ? Colors.white70 : iconInactive,
                          ),
                          title: Text(
                            item['label'] as String,
                            style: GoogleFonts.roboto(
                              fontSize: 16,
                              color: _darkModeState >= 1 ? Colors.white70 : textSecondary,
                              fontWeight: FontWeight.w500,
                            ),
                          ),
                          children: (item['items'] as List<Map<String, dynamic>>).map((subItem) {
                            return ListTile(
                              leading: Icon(
                              ...
                              onTap: () {
                                _setPage(subItem['page'] as Widget, subItem['label'] as String);
                      ...
                      return _MobileNavItem(
                        ...
                        isSelected: _selectedButton == item['label'],
                        onTap: () {
                          _setPage(item['page'] as Widget, item['label'] as String);
                          Navigator.pop(context); // Close drawer
                        },
                        isDarkMode: _darkModeState >= 1,
                      );
                    ...
                    return ExpansionTile(
                      ...
                      children: (item['items'] as List<Map<String, dynamic>>).map((subItem) {
                        return ListTile(
                          ...
                          onTap: () => _setPage(subItem['page'] as Widget, subItem['label'] as String),
                        );
                      }).toList(),
                    );
                  }
